'''
    ...
    PROGRAMA PRINCIPAL RESPONSAVEL POR SIMULAR O FRACTAL DE SIERPINSKI

    -> Conta com 6 opcoes basicas:

    1. Run (inicia a geracao de N pontos com base nas regras de geracao do fractal pela Teoria do caos)
    2. Clear (elimina todos os pontos gerados anteriormente, se presentes)
